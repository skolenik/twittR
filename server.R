server <- function(input, output, session) {
  ...
  #user/hashtag lists
  users <- t(data.frame(c("@katyperry","@HillaryClinton","@BarackObama","@taylorswift13","@rihanna",
                          "@YouTube","@TheEllenShow","@ladygaga","@StephenAtHome","@Twitter","@jtimberlake",
                          "@britneyspears","@elonmusk","@JohnCena","@cnnbrk","@selenagomez","@BillNye","@DalaiLama",
                          "@David_Cameron","@SteveMartinToGo","@AlYankovic","@Instagram","@Oprah","@nytimes","@KingJames",
                          "@ClickHole","@Drake","@BillGates","@CNN","@KevinHart4real","@SportsCenter","@GeorgeTakei",
                          "@BBCBreaking","@MerriamWebster","@chemshow","@espn","@theOnion","@narendramodi","@LilTunechi",
                          "@SenWarren","@NiallOfficial","@wizkhalifa","@50Cent","@TheRock","@realDonaldTrump","@jk_rowling",
                          "@Adele","@SamuelLJackson","@linkinpark","@ActuallyNPH","@danieltosh","@aliciakeys","@cooperhefner",
                          "@NBA","@iamsrk","@EmmaWatson","@yokoono","@johngreen","@LiamPayne","@jimmyfallon","@NASA",
                          "@neiltyson","@ConanOBrien","@BeingSalmanKhan","@OzzyOsbourne","@NFL","@tonyhawk","@JerrySeinfeld",
                          "@davidguetta","@steveaoki","@NICKIMINAJ","@Eminem","@AvrilLavigne","@Metallica","@drdre",
                          "@TheEconomist","@coldplay","@chrisbrown","@BBCWorld","@blakeshelton","@edsheeran","@fucktyler",
                          "@DAVID_LYNCH","@PMOIndia","@Google","@MariahCarey","@Reuters","@LeoDiCaprio","@djkhaled","@POTUS",
                          "@NatGeo","@priyankachopra","@pattonoswalt","@SnoopDogg","@xtina","@RyanSeacrest","@drose",
                          "@neilhimself","@aayylmao", "@ObamaMalik")))
  
  hashtags <- t(data.frame(c("#love","#yolo","#beautiful","#fashion","#tbt","#happy","#cute","#me","#friends","#summer",
                             "#art","#fun","#smile","#nature","#family","#style","#life","#travel","#beauty","#dog","#pretty",
                             "#swag","#cat","#party","#baby","#lol","#motivation","#funny","#lifestyle","#politics","#trump",
                             "#altright","#ff","#music","#datascience","#informatics","#blacklivesmatter","#notmypresident",
                             "#maga","#draintheswamp","#sxsw","#idol","#WalkingDead","#npr","#grammys","#god","#idol","#2k17",
                             "#subtweet","#tb","#avi","#np","#nowplaying","#sports","#football","#golf","#bestfriend","#hilarious",
                             "#wedding","#gym","#motivation","","#nighttime","#amazing","#sundayfunday","#qotd","#quoteoftheday",
                             "#google","#facebook","#marketing","#education","#bookoftheday","#faith","#calm","#believe","#thankful",
                             "#nutritious","#cruise","#vacation","#empower","#productivity","#baking","#yummy","#gourmet","#stressed",
                             "#overwhelmed","#GivingTuesday","","#TrumpRussia","#news","#quote","#fakenews","#job","#win","#lose",
                             "#giveaway","#macron","#manchester","#breaking","#auspol")))
